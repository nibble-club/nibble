...
export type RestaurantInfoFragment = { __typename?: "Restaurant" } & Pick<
  Restaurant,
  "id" | "name" | "market" | "description" | "disclaimer" | "active"
> & {
    address: { __typename?: "Address" } & Pick<
      ...
      | "postalCode"
    > & {
        location: { __typename?: "LatLon" } & Pick<LatLon, "latitude" | "longitude">;
      };
    logoUrl: { __typename?: "S3Object" } & Pick<S3Object, "bucket" | "region" | "key">;
    heroUrl: { __typename?: "S3Object" } & Pick<S3Object, "bucket" | "key" | "region">;
  };
...
export type GeocodeAddressQuery = { __typename?: "Query" } & {
  geocodeAddress: { __typename?: "LatLon" } & Pick<LatLon, "latitude" | "longitude">;
};
...
export type ImageUploadUrlQuery = { __typename?: "Query" } & {
  imageUploadURL: { __typename?: "ImageUploadDestination" } & Pick<
    ImageUploadDestination,
    "presignedUrl"
  > & {
      destination: { __typename?: "S3Object" } & Pick<
        S3Object,
        "bucket" | "region" | "key"
      >;
    };
...
export type NibbleInfoQuery = { __typename?: "Query" } & {
  nibbleInfo: { __typename?: "NibbleAvailable" } & NibbleAvailableInfoFragment;
};

export type RestaurantForAdminQueryVariables = Exact<{ [key: string]: never }>;

export type RestaurantForAdminQuery = { __typename?: "Query" } & {
  restaurantForAdmin: { __typename?: "Restaurant" } & {
    nibblesAvailable: Array<
      Maybe<{ __typename?: "NibbleAvailable" } & NibbleAvailableInfoFragment>
    >;
