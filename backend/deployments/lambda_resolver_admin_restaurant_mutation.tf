module resolver_admin_restaurant_mutation_lambda {
  ...
  function_name      = "${var.environment_namespace}-resolver_admin_restaurant_mutation"
  ...
  role_arn           = aws_iam_role.resolver_admin_restaurant_mutation.arn
  role_name          = aws_iam_role.resolver_admin_restaurant_mutation.name
  runtime            = "python3.7"
  timeout            = 10
...
# roles and policies
resource aws_iam_role resolver_admin_restaurant_mutation {
  name                 = "${var.environment_namespace}-resolver_admin_restaurant_mutation_lambda"
...
resource aws_iam_role_policy_attachment resolver_admin_restaurant_mutation {
  role       = aws_iam_role.resolver_admin_restaurant_mutation.name
  policy_arn = aws_iam_policy.resolver_admin_restaurant_mutation.arn
}
